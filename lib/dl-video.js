...
function apikey () {
    ...
    switch (ran) {
        case 0:
            return `4oDiUTSEtPFUEkFkCsUkL6VOgkmULaInNGtox6O0BiFDbNg`
            break;
        case 1:
            return `yCQ7tAap5DPglasdoYOcP6ZeeccI5TMx5tCok2yyHw1Xsr1guV`
            break
        case 2:
            return `IO5ldoA9fW7Wtv1gvY2pTKjATO2jyQwfn8EYhRt74JBCz8c2BW`
            break
        default:
            break;
    }
